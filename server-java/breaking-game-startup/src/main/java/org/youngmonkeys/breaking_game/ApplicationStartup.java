package org.youngmonkeys.breaking_game;
...
import org.youngmonkeys.breaking_game.plugin.PluginEntry;
import org.youngmonkeys.breaking_game.plugin.PluginEntryLoader;
import org.youngmonkeys.breaking_game.app.AppEntry;
import org.youngmonkeys.breaking_game.app.AppEntryLoader;

public class ApplicationStartup {
	
	public static final String ZONE_APP_NAME = "breaking-game"; 
		...
		public EzyPluginEntry load() throws Exception {
			return new PluginEntry() {
				...
				private String getPluginPath(EzyPluginSetting setting) {
					Path pluginPath = Paths.get("breaking-game-plugin");
					if(!Files.exists(pluginPath))
						pluginPath = Paths.get("../breaking-game-plugin");
		...
		public EzyAppEntry load() throws Exception {
			return new AppEntry() {
				...
				private String getAppPath() {
					Path pluginPath = Paths.get("breaking-game-app-entry");
					if(!Files.exists(pluginPath))
						pluginPath = Paths.get("../breaking-game-app-entry");
					return pluginPath.toString();
				}
			};
		}
